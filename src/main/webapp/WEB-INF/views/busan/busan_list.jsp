            ...
            <div class="col-lg-6 col-md-6 col-sm-6" v-for="vo in store.list">
                <div class="blog__item">
                    <div class="blog__item__pic">
                        <img :src="vo.image1" :title="vo.address" alt="" style="width: 290px; height: 207px;">
                    </div>
                    <div class="blog__item__text">
                        ...
                        <p>{{vo.address}}</p>
                        <a :href="'http://localhost:8080/busan/detail?no='+vo.no" class="blog__btn">READ MORE <span class="arrow_right"></span></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-12">
